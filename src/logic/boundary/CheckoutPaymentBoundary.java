...
import logic.bean.CheckoutPaymentBean;
import javafx.scene.control.PasswordField;
import javafx.scene.control.Button;

public class CheckoutPaymentBoundary {	
	...
	private CheckoutPaymentBean checkoutPaymentBean = null;
	
	
	public void initialize() {
		checkoutPaymentBean = new CheckoutPaymentBean();
	...
	public void onBackToSummaryPressed() {
		if(checkoutBoundary != null) {
			checkoutBoundary.openTab(CheckoutBoundary.Tab.SUMMARY);
		}
	}
	...
	public void confirmPurchase() {
		...
		try {
			...
			if(checkoutBoundary != null) {
				...
				checkoutBoundary.openTab(CheckoutBoundary.Tab.CONFIRMATION);
			}
